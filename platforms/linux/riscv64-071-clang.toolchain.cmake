...
set(CMAKE_C_FLAGS "-march=rv64gcv0p71 -menable-experimental-extensions -O3 --gcc-toolchain=${RISCV_GCC_INSTALL_ROOT} -w ${CMAKE_C_FLAGS}")
set(CMAKE_CXX_FLAGS "-march=rv64gcv0p71 -menable-experimental-extensions -O3 --gcc-toolchain=${RISCV_GCC_INSTALL_ROOT} -w ${CXX_FLAGS}")
